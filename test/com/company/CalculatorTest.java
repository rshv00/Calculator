...
public class CalculatorTest {
    ...
    public void sameSimpleInteger6() throws Exception {
        assertThat(calculator.calculate("6")).isEqualTo("6");
    }

    @Test
    public void sameSimpleInteger8() throws Exception {
        assertThat(calculator.calculate("8")).isEqualTo("8");
    }
    ...
    public void addTwoSimpleInteger3() throws Exception {
        assertThat(calculator.calculate("9+5")).isEqualTo("14");
    }

    @Test
    public void minusTwoSimpleInteger() throws Exception {
        assertThat(calculator.calculate("9-5")).isEqualTo("4");
    }

    @Test
    public void multiplieTwoSimpleInteger() throws Exception {
        assertThat(calculator.calculate("9*5")).isEqualTo("45");
    }
    ...
    public void divideTwoSimpleInteger2() throws Exception {
        assertThat(calculator.calculate("9/5")).isEqualTo("1");
    }

    @Test
    public void sameTwoDigitInteger1() throws Exception {
        assertThat(calculator.calculate("11")).isEqualTo("11");
    }

    @Test
    public void addTwoTwoDigitInteger() throws Exception {
        assertThat(calculator.calculate("19+5")).isEqualTo("24");
    }
    @Test
    public void addTwoTwoDigitInteger21() throws Exception {
        assertThat(calculator.calculate("5+19")).isEqualTo("24");
    }


    @Test
    public void addTwoTwoDigitInteger2() throws Exception {
        assertThat(calculator.calculate("19+15")).isEqualTo("34");
    }

    @Test
    public void minusTwoTwoDigitInteger() throws Exception {
        assertThat(calculator.calculate("19-15")).isEqualTo("4");
    }
    @Test
    public void minusTwoTwoDigitInteger2() throws Exception {
        assertThat(calculator.calculate("4-15")).isEqualTo("-11");
    }
    @Test
    public void minusTwoTwoDigitInteger221() throws Exception {
        assertThat(calculator.calculate("15-4")).isEqualTo("11");
    }
}